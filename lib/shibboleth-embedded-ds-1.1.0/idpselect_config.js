...
function IdPSelectUIParms(){
    ...
    this.defaultLogo = 'http://placehold.it/1x1'  // Replace with your own logo was: transparent-eds-logo.png
    ...
    this.helpURL = 'https://registry-dev.commons.mla.org/registry/pages/public/help';
    ...
    'en': {
        ...
        'idpEntry.NoPreferred.label': 'Or enter your organization\'s name',
        'idpList.label': 'Select your organization from the list below',
        'idpList.NoPreferred.label': 'Or select your institution from the list below',
