...
function IdPSelectUIParms(){
    ...
    this.defaultLogo = 'transparent-eds-logo.png'  // Replace with your own logo
    ...
    'en': {
        ...
        'idpPreferred.label': 'Or use a previous selection',
        ...
        'idpList.NoPreferred.label': 'Or select your organization from the list below',
