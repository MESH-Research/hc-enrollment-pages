...
function IdPSelectLanguages(){
    ...
    'en': {
        ...
        'idpPreferred.label': 'Log in the same way you did last time.',
        'idpEntry.label': 'Or use a previously linked university account.',
        ...
        'autoFollow.time0' : ' Rememeber this for 30 days.',
